...
async function main() {
  ...
  await import("@/lib/products/transcode-worker"); // Product video transcode (raw R2 → 1080p MP4)
  await import("@/lib/products/video-reaper-worker"); // Reaps abandoned processing-video rows
