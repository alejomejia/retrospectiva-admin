...
export const m = {
  ...
  toasts: {
    ...
    videoProcessing:
      "Procesando video (optimizando calidad y tamaño)… puede tardar unos segundos.",
  },
  ...
  errors: {
    ...
    videoProcessingFailed:
      "No se pudo procesar el video. Verifica que el archivo no esté dañado e inténtalo con otro.",
